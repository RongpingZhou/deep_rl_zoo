...
#   print("inPattern shape is: ", inPattern.shape)
#   print("inPattern is: ")
  
#   print(inPattern)
#   print("inPattern[0] shape is: ", inPattern[0].shape)
#   print("(inPattern[0] is: ")
#   print(np.asarray(inPattern[0]))
#   print("nInput: ", nInput)
#   print("np.ndim(np.asarray(inPattern[0]))", np.ndim(np.asarray(inPattern[0])))
#   print("np.ndim(inPattern[0])", np.ndim(inPattern[0]))
...
def importNet(fileName):
  ...
  print("wMat shape is: ", wMat.shape)
  print("wMat is: ", wMat)
