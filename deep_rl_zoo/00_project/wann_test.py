...
def main(argv):
  ...
  view    = args.view
  seed    = args.seed
  print("hyp_default is: ", hyp_default)

  # Load task and parameters
  hyp = loadHyp(pFileName=hyp_default)

  print("hyp_adjust is: ", hyp_adjust)
  ...
  print("wVec shape is: ", wVec.shape)
  print("wVec is: ", wVec)
  print("aVec shape is: ", aVec.shape)
  print("aVec is: ", aVec)
  print("wKey shape is: ", wKey.shape)
  print("wKey is: ", wKey)
